            ...
            <animated.div style={animation}>
                <div className="updateModal">
                    <div className = 'headAccInf'>
                        ...
                        <i class="fa-regular fa-x" onClick={handleClose} style={{cursor: 'pointer'}}></i>
                    </div> 
                    <div className="updateContent">
                        ...
                        <div className="nameUpdate">
                            ...
                            <input type="text" value="Mai Anh" id="nameInput"/>
                        ...
                        <div className="inforUser">
                                ...
                                <div className="infUpdate">
                                    <form>
                                        ...
                                        <input type="radio" id='male' name='sex' value='Nam' className="sex"/>
                                        <label for='male' className="text">Nam</label>
                                        <input type="radio" id='female' name='sex' value='Nữ' checked className="sex"/>
                                        <label for='female' className="text">Nữ</label>
                                        
                                        <p className="text">Ngày sinh</p>
                                        <div className="dateUpdate">
                                            <select id='day' name='days' onClick={()=>{setFlagDay(false)}} >
                                            ...
                                            <select id='month' name='months' onClick={()=>{setFlagMonth(false)}} onChange={(e)=>{setMonth(e.target.value)}}>
                                            ...
                                            <select id='year' name='years' onClick={()=>{setFlagYear(false)}} onChange={(e)=>{setYear(e.target.value)}}>
                                        ...
                                        <button className='cancelbtn' onClick={handleClose}>Hủy</button>
                                    </form>
                                </div>
                            </div>
                    </div> 

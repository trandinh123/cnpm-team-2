    ...
    return (
        accInfOpen && (
            <div className='accContainer' ref={modalRef} onClick={closeModal}>
                <animated.div style={animation}>
                    <div className='accModal'>
                        <div className='headAccInf'>
                            ...
                            <i onClick={() => setAccInfOpen(false)} class="fa-regular fa-x" style={{ cursor: "pointer", padding: '0 5px' }}></i>
                        </div>
                        <div className='contentAccInf'>
                            <div className='imageAcc'>
                                ...
                                <h5 className='nameAcc'>Mai Anh</h5>
                            </div>
                            <div className="inforUser">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p className="cntInf">IT</p>
                                    </li>
                                    <li>
                                        <p className="titleInf">Điện thoại</p>
                                        <p className="cntInf">+84123499888</p>
                                    </li>
                                    <li>
                                        <p className="titleInf">Giới tính</p>
                                        <p className="cntInf">Nữ</p>
                                    </li>
                                    <li>
                                        <p className="titleInf">Ngày sinh</p>
                                        <p className="cntInf">14 tháng 01, 2002</p>
                                    </li>
                                </ul>
                ...
                <UpdateModal setOpenModal={setOpenModal} openModal={openModal} setAccInfOpen={setAccInfOpen} />
            </div>
        )
    )
}
